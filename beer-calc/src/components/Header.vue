<template>
    <header class="header">
        <div class="logoDiv">
            ...
            <h2 class="montserrat-preset-1-regular name">Beer<span :class="theme ? `name-span-dark` : `name-span`">Calc</span></h2>
        </div>
        <button  @click="themeFunc" :class="theme ? `theme-active` : `theme-btn`"></button>
    </header>
</template>
...
<script setup lang="ts">
    ...
    const { theme, themeFunc } = defineProps<ButtonProps>()
